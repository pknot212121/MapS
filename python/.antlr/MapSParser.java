...
public class MapSParser extends Parser {
	...
	public static final int
		...
		RULE_loopStatement = 18, RULE_expression = 19, RULE_functionCall = 20, 
		RULE_pointAccess = 21, RULE_listAccess = 22, RULE_pointExpression = 23, 
		RULE_heightExpression = 24, RULE_listExpression = 25, RULE_listElementExpression = 26, 
		RULE_type = 27, RULE_assignment = 28, RULE_variableAssignment = 29, RULE_pointFieldAssignment = 30, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"heightExpression", "listExpression", "listElementExpression", "type", 
			"assignment", "variableAssignment", "pointFieldAssignment", "listAssignment"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2269814427538798068L) != 0)) {
				{
				{
				setState(64);
				statement();
	...
	public final PointAccessContext pointAccess() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_pointAccess);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final PointExpressionContext pointExpression() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_pointExpression);
		try {
			setState(407);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final HeightExpressionContext heightExpression() throws RecognitionException {
		...
		enterRule(_localctx, 48, RULE_heightExpression);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(409);
	...
	public final ListElementExpressionContext listElementExpression() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_listElementExpression);
		try {
			setState(435);
			_errHandler.sync(this);
	...
	public final PointFieldAssignmentContext pointFieldAssignment() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_pointFieldAssignment);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ListAssignmentContext listAssignment() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_listAssignment);
		try {
			setState(479);
			_errHandler.sync(this);

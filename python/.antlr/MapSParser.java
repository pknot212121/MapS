...
public class MapSParser extends Parser {
	...
	public static final int
		...
		DOUBLE=53, INT=54, STRING=55, BOOLEAN=56, WHITESPACE=57, LINE_COMMENT=58;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, "IDENTIFIER", "DOUBLE", "INT", "STRING", "BOOLEAN", 
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 139611696120515964L) != 0)) {
				{
				{
				setState(62);
				statement();
	...
	public final FunctionCallContext functionCall() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 139611657167964160L) != 0)) {
				{
				setState(364);
				expression(0);
				setState(369);
